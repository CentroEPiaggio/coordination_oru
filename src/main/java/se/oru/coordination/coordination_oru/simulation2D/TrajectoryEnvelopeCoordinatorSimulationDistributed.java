...
import se.oru.coordination.coordination_oru.TrajectoryEnvelopeCoordinatorDistributed;
import se.oru.coordination.coordination_oru.TrajectoryEnvelopeTrackerDummy;
import se.oru.coordination.coordination_oru.motionplanning.AbstractMotionPlanner;

public class TrajectoryEnvelopeCoordinatorSimulationDistributed extends TrajectoryEnvelopeCoordinatorDistributed {
	 ...
	 * </ul>
	 */
	public TrajectoryEnvelopeCoordinatorSimulationDistributed() {
	 ...
	 * </ul>
	 */
	public TrajectoryEnvelopeCoordinatorSimulationDistributed(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION, double MAX_VELOCITY, double MAX_ACCELERATION) {
	 ...
	 * </ul>
	 */
	public TrajectoryEnvelopeCoordinatorSimulationDistributed(double MAX_VELOCITY, double MAX_ACCELERATION) {
	 ...
	 */
	public TrajectoryEnvelopeCoordinatorSimulationDistributed(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION) {
	 ...
	 */
	public TrajectoryEnvelopeCoordinatorSimulationDistributed(int CONTROL_PERIOD, double TEMPORAL_RESOLUTION, double MAX_VELOCITY, double MAX_ACCELERATION, int trackingPeriodInMillis) {
	...
	public AbstractTrajectoryEnvelopeTracker getNewTracker(TrajectoryEnvelope te, TrackingCallback cb) {
		...
		TrajectoryEnvelopeTrackerRK4Distributed ret = new TrajectoryEnvelopeTrackerRK4Distributed(te, trackingPeriodInMillis, TEMPORAL_RESOLUTION, MAX_VELOCITY, MAX_ACCELERATION, this, cb) {
